...
export const items = [
    ...
    { id: 2, name: "Deku Nuts", hasItem: null, image: DekuNuts, quantity: 0 },
    { id: 3, name: "Bomb Bag", hasItem: null, image: BombBag, quantity: 0 },
    { id: 4, name: "Fairy Bow", hasItem: null, image: FairyBow, quantity: 0 },
    ...
    { id: 8, name: "MasterSword", hasItem: null, image: MasterSword }
];